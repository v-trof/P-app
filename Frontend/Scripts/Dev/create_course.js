var create_course_html = "<form action='func/create_course/' method='post'>{% csrf_token %}<input type='text' name='course_name'><label for='course_name' required>Название курса</label><br><br>"+
