...
func_patterns = [
    ...
    url(r'^accept_sharing/$', functional.Universal_views.accept_sharing, name="accept_sharing"),
    url(r'^decline_sharing/$', functional.Universal_views.decline_sharing, name="decline_sharing"),
    url(r'^delete_info/$', functional.Universal_views.delete_info, name="delete_info"),
    url(r'^get_shared/$', functional.Universal_views.get_shared, name="get_shared"),
    url(r'^load_tags/$', functional.Universal_views.load_tags, name="load_tags"),
...
course_patterns = [
    ...
    url(r'^(?P<course_id>[0-9]+)/results/$', main.Course_group.results, name='results'),
     url(r'^(?P<course_id>[0-9]+)/unpublished/$', main.Course_group.unpublished, name='results'),
...
urlpatterns = [
    ...
    url(r'^404/$', main.Error_group.not_found, name="404"),
